 ...
 {/* async function handleSubmit(e: FormEvent:<HTMLFormElement>) {
  ...
  return (
    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <form className="mb-32 text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
        <div className='w-full mb-4'>
          <label className="block items-center justify-center" htmlFor="prompt-input">
