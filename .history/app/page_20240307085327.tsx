 ...
 {/* async function handleSubmit(e: FormEvent:<HTMLFormElement>) {
  ...
  return (
    ...
    <main className="flex min-h-screen flex-col items-center pt-6 px-24">
      ...
      <div className="z-10 max-w-5xl w-full items-center justify-between py-8 font-mono text-sm flex flex-row">
        ...
        <div className="bottom-0 left-0 justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black h-auto w-auto bg-none">
          {/*<div>
            Dak
  </div>*/}
          <a
      ...
      <div className="relative flex flex-col place-items-center pb-8 before:absolute before:h-[300px] before:w-full sm:before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-full sm:after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40 before:lg:h-[360px] z-[-1]">
