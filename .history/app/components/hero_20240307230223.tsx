...
export default function Hero() {
    ...
    return (
        <div className="flex flex-col relative justify-center items-center h-screen md:py-10 py-6 overflow-wrap max-w-3xl">
            ...
            <p className="text-base font-bold md:pb-4">powered by GPT-3</p>
            <div className="text-sm">Hey spookie! Generate a random pun from a topic to brighten your day</div>
            <div className='mx-[2rem] relative w-full flex items-center aspect-[11/6]'>
                
                <Image src={'/public/assets/OIP-crackmeup.jpg'} alt='Home Page' width={100} height={100} />
            </div>
