        ...
        <div className="flex flex-col relative justify-center items-center h-screen md:py-10 py-6 overflow-wrap max-w-3xl px-5">
            ...
            <form onSubmit={handleSubmit} className='flex flex-col justify-between mb-32 text-center items-center'>
                <div className='mb-4'>
                    ...
                    <input
                        className="shadow appearance-none border rounded w-full py-2 px-5 text-black dark:text-white leading-tight focus:outline-none focus:shadow-outline"
                        id="prompt-input"
                        type="text"
                        placeholder="e.g. money, code, fruits">
                    </input>
                </div>
                <button type='submit' className='mb-3 border static rounded-xl bg-gray-200 py-2 px-4 hover:bg-zinc-400 dark:bg-white' disabled={punLoading}>
                    Stupid pun
                </button>
            </form>
