...
export default function Hero() {
    ...
    return (
        <div className="flex flex-col relative justify-center items-center h-screen md:py-16 py-6 overflow-wrap">
            ...
            <div className="text-base ">Hey spookie! Generate a random pun from a topic to brighten your day</div>
