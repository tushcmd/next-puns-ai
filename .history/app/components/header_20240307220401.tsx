...
export default function Header() {
    return (
        <header className="fixed flex justify-center items-center w-full z-50 t-0 bg-gradient-to-b from-zinc-200 pt-8 backdrop-blur-2xl dark:bg-zinc-800/30 dark:from-inherit">
            <div className="flex flex-row items-center w-full md:max-w-5xl px-6 justify-between font-mono text-sm">
                <Link
                    className=""
                    href='/'
                >
