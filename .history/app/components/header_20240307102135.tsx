export default function Header() {
    return (
       {/*} <div className="flex flex-row z-10 max-w-5xl w-full items-center justify-between font-mono text-sm">
        ...
        <header className='fixed flex justify-center items-center w-full z-50 t-0 border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30'>
