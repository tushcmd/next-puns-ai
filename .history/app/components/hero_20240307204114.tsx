...
export default function Hero() {
    ...
    return (
        <div>
            ...
            <div className='mx-[2rem] relative w-full flex items-center aspect-video'>
                <Image
            ...
            <form onSubmit={handleSubmit} className='flex flex-col justify-between mb-32 text-center'>
                ...
                <button type='submit' className='mb-3 border static w-auto  rounded-xl bg-gray-200 lp-4 dark:bg-zinc-800/30' disabled={punLoading}>
                    Stupid pun
                </button>
            </form>
