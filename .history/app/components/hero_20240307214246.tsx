...
export default function Hero() {
    ...
    return (
        <div className="flex flex-col relative justify-center items-center h-screen md:py-16 py-6 overflow-auto">
            <p className="text-3xl font-bold py-2 bg-gradient-to-br from-fuchsia-500 to-cyan-500 bg-clip-text text-transparent">Pun AI</p>
